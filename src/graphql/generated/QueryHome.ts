...
import { ENUM_COMPONENTPAGERIBBON_COLOR, ENUM_COMPONENTPAGERIBBON_SIZE, ENUM_COMPONENTPAGEHIGHLIGHT_ALIGNMENTE } from "./globalTypes";
...
export interface QueryHome_sections_newGames_highlight {
  ...
  buttonLabel: string;
  buttonLink: string;
  alignmente: ENUM_COMPONENTPAGEHIGHLIGHT_ALIGNMENTE | null;
}
